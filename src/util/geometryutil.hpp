...
namespace TK {
    ...
    */
    inline tkVec3f polarToVec3(tkFloat sinTheta, tkFloat cosTheta, tkFloat phi) {
        return tkVec3f(sinTheta * std::cos(phi), sinTheta * std::sin(phi), cosTheta);
    }
    ...
    */
    ...
    inline tkVec3f polarToVec3(tkFloat sinTheta, tkFloat cosTheta, tkFloat phi, const tkVec3f& x,
                               const tkVec3f& y, const tkVec3f& z) {
